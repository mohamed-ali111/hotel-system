                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ route('paid_invoices') }}">الفواتير المدفوعة</a>
                            </li>
                        @endcan
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ route('partpaid_invoices') }}">الفواتير الغير
                                    مدفوعة</a></li>
                        @endcan
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ route('unpaid_invoices') }}">الفواتير المدفوعة
                                    جزئيا</a></li>
                        @endcan
                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ route('archevis_invoices') }}">الفواتير المارشفه</a></li>
                        @endcan
            ...
            @can('الاعدادات')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @endcan
                        @can('المنتجات')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'show')) }}"> المنتجات</a></li>
                        @endcan
                    </ul>
                </li>
